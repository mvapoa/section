...
1. Clonar o projeto localmente: `https://github.com/mvapoa/section.git`
2. Acessar a raiz do projeto
3. Empacotar a aplicação: `./gradlew build`
4. Subir os contêineres: `docker-compose up`
5. Visualizar todos os endpoints da API: [http://localhost:8001/swagger-ui.html](http://localhost:8001/swagger-ui.html)
